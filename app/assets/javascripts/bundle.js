...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    KeyListener = __webpack_require__(165);
	...
	var Organ = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Key, { noteName: 'C4' }),
	      React.createElement(Key, { noteName: 'C#4' }),
	      React.createElement(Key, { noteName: 'D4' }),
	      React.createElement(Key, { noteName: 'D#4' }),
	      React.createElement(Key, { noteName: 'E4' }),
	      React.createElement(Key, { noteName: 'F4' }),
	      React.createElement(Key, { noteName: 'F#4' }),
	      React.createElement(Key, { noteName: 'G4' }),
	      React.createElement(Key, { noteName: 'G#4' }),
	      React.createElement(Key, { noteName: 'A4' }),
	      React.createElement(Key, { noteName: 'A#4' }),
	      React.createElement(Key, { noteName: 'B4' }),
	      React.createElement(Key, { noteName: 'C5' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Key = React.createClass({
	  ...
	  render: function () {
	    var list = this.playing === true ? React.createElement(
	      'p',
	      null,
	      React.createElement(
	        'b',
